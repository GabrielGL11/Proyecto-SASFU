...
while True:#Menú de administrador
    ...
    print("3. Abrir postulaciones")
    print("4. Cerrar postulaciones")
    print("5. Salir")
    opcion = input("Seleccione una opción (1-5): ")#Solicitar opción
    if opcion == "1":#Abrir inscripciones con fechas personalizadas
    ...
    elif opcion == "3":#Abrir postulaciones con fechas personalizadas
        ...
        try:#Validar formato de fechas
            ...
            print("Error en las fechas:", e)
    elif opcion == "4":#Cerrar postulaciones
